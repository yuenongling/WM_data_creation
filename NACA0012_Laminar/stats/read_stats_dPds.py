...
num_points = 2000            # Number of equally spaced points desired
...
Num_points_along_normal = 1  # Number of points along the normal direction for interpolation
MAX_NORMAL_LENGTH = 0.00025  # Length of the normal line for visualization
MIN_NORMAL_LENGTH = 0.00025  # Minimum length of the normal line for visualization
points_to_interp = []
s_distance = []
...
diffs = np.diff(points_to_interp, axis=0)      # Differences between consecutive points
...
dpds = np.gradient(interpolated_P, s, axis=0)
nu = 1 / 5000
