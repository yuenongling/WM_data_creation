...
STATS_PATH = os.path.join(WM_DATA_PATH, "periodic_hill_Balakumar", "stats")
...
def process_and_save_region_data(
    ...
    save_to_hdf5(data_dict, f"ph_B_data")
...
X, Y, cf_data, cp_data = load_cf_cp_data()
